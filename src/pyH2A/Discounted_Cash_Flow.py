...
class Discounted_Cash_Flow:
	...
	final_product_cost : float
		Levelized cost of final product per functional unit.
	contributions : dict
	...
	**Plugins**
	...
	def final_product_sales(self):
		...
		self.annual_sales = self.output_per_year_at_gate.unit[fu.FU]
	...
	def cost_contribution(self):
		...
		revenue = self.expenses_per_functional_unit(self.npv_dict['revenue'])

		self.contributions = {'Data': {'Initial equity depreciable capital': self.expenses_per_functional_unit(self.npv_dict['initial_equity_depreciable_capital']),
						   			   'Non depreciable capital' : self.expenses_per_functional_unit(self.npv_dict['non_depreciable_capital_costs']),
						 			   'Replacement costs' : self.expenses_per_functional_unit(self.npv_dict['replacement_costs']),
						      		   'Salvage' : -self.expenses_per_functional_unit(self.npv_dict['salvage']),
						 	  		   'Decomissioning' : self.expenses_per_functional_unit(self.npv_dict['decomissioning']),
						  	  		   'Fixed operating costs' : self.expenses_per_functional_unit(self.npv_dict['fixed_operating_costs']),
						 	  		   'Variable operating costs' : self.expenses_per_functional_unit(self.npv_dict['variable_operating_costs']),
						 	  		   'Working capital reserve' : self.expenses_per_functional_unit(self.npv_dict['working_capital_reserve']),
						   	  		   'Interest' : self.expenses_per_functional_unit(self.npv_dict['interest']),
						      		   'Principal payment' : self.expenses_per_functional_unit(self.npv_dict['principal_payment']),
						      		   'Taxes' : self.expenses_per_functional_unit(self.npv_dict['taxes'])}
						      		   }

		self.contributions['Total'] = self.final_product_cost
		self.contributions['Table Group'] = 'Total cost of delivered product'

	def expenses_per_functional_unit(self, value):
