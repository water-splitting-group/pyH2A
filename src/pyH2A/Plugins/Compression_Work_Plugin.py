...
class Compression_Work_Plugin:
    ...
    Technical Operating Parameters and Specifications > Plant Design Capacity (kg of H2/day)
    ...
    def thermodynamic_compression_work(self, dcf):
        ...
        '''
        molar_flowrate_to_compress =  dcf.inp['Technical Operating Parameters and Specifications']['Plant Design Capacity (kg of H2/day)']['Value']/(86400*FP.MW['H2']*dcf.inp['Raw product gas']['Hydrogen molar fraction']['Value']) # mol/s       
