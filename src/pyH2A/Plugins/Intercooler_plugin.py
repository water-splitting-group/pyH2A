...
# This is based on the Cooler condenser plugin template. 
# The unit is here called "Intercooler"

# map the generic compressor inlet and outlet to the specifics of the flowsheet 
Cooler_condenser_inlet = 'Compressor 1 outlet'
Cooler_condenser_outlet_gas = 'Intercooler outlet gas'                
Cooler_condenser_outlet_liq = 'Intercooler outlet liq'      
Cooler_condenser = 'Intercooler'        
        
        
class Intercooler_plugin:
 ...
 Parameters
    ...
    Intercooler > Outlet temperature > Value : float
        Temperature at the outlet of the unit operation.
        
    Returns
    -------
    Intercooler outlet gas > Species > Value : set, str
        Chemical species present at the outlet. Each species is defined by a string in the set.    
    Intercooler outlet gas > Flowrate > Value : float
        Fluid mass flowrate at the outlet of the unit operation.
    Intercooler outlet gas > Pressure > Value : float
        Pressure at the outlet of the unit operation.
    Intercooler outlet gas > Temperature > Value : float
        Temperature at the outlet of the unit operation.
    Intercooler outlet gas > Enthalpy > Value : float
        Specific enthalpy at the outlet of the unit operation.
    Intercooler outlet gas > Composition > Value : dict
        Mass fraction of the species at the outlet of the unit operation.
    Intercooler outlet liq > Species > Value : set, str
        Chemical species present at the outlet. Each species is defined by a string in the set.    
    Intercooler outlet liq > Flowrate > Value : float
        Fluid mass flowrate at the outlet of the unit operation.
    Intercooler outlet liq > Pressure > Value : float
        Pressure at the outlet of the unit operation.
    Intercooler outlet liq > Temperature > Value : float
        Temperature at the outlet of the unit operation.
    Intercooler outlet liq > Enthalpy > Value : float
        Specific enthalpy at the outlet of the unit operation.
    Intercooler outlet liq > Composition > Value : dict
        Mass fraction of the species at the outlet of the unit operation.
    Intercooler > Heat rate input > Value : float 
        Thermal power injected into the system
    Intercooler Direct Capital Costs > Capital Cost 1 ($) > Value : float
    ...
    def __init__(self, dcf, print_info):
        ...
        insert(dcf, 'Intercooler Direct Capital Costs', 'Capital Cost 1 ($)', 'Value', 
    ...
    def mass_balance(self, dcf):
        ...
        self.Outlet_2_composition = {'H2O' : 1.0, 'H2':0}
