...
input_dict = {
	"Technical Operating Parameters and Specifications": {
		"Plant design capacity": {
			...
			"optional": False,
			"description": "Plant design capacity of hydrogen production plant in mass per unit of time."
		},
	},	
...
class Solar_Thermal_Plugin:
	...
	Technical Operating Parameters and Specifications > Plant design capacity > Value : float
		Plant design capacity of hydrogen production plant in mass per time.
