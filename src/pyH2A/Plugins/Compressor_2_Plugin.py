...
# The unit is here called Compressor 2 

# map the generic compressor inlet and outlet to the specifics of the flowsheet 
compressor_inlet = 'Intercooler outlet gas'
compressor_outlet = 'Compressor 2 outlet' 
...
class Compressor_2_Plugin:
    ...
    Compressor 2 outlet > Pressure > Value : float
        Pressure at the outlet of the first compressor.                
    Compressor 2 > Polytropic coefficient > Value : float, optional
        Polytropic coefficient of the compression (-). Defaults to 1.4.
    Compressor 2 > Compressor efficiency > Value : float
        Compression work per shaft work provided to the compressor (-).          
    Compressor 2 > Combustion to shaft efficiency > Value : float
    ...
    def __init__(self, dcf, print_info):
        ...
        insert(dcf, 'Compressor 2 Direct Capital Costs', 'Capital Cost ($)', 'Value', 
