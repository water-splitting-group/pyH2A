...
class Capital_Cost_Plugin:
	...
	def _set_up(self, dcf):
		...
		self.__doc__ = generate_docstring("Calculation of Capital Cost.", self.input_dict, self.output_dict)
	...
	def _run(self, dcf):
		...
		output_inserter_function(self.output_dict, self, dcf, 'Capital_Cost_Plugin')
