...
output_dict = {
    "Cooler Condenser 2": {
        ...
        "Cooling water flowrate": {
            ...
            "optional": False,
            "description": "Average mss flowrate of the cooling water, accounting for the operating capacity factor."
        },                   
    },
    "Main Stream": {
        "Temperature": {
...
class Cooler_Condenser_2_Plugin:
    ...
    def cooler_condenser_sizing(self):
        ...
        self.coolant_flowrate = Quantity(self.input_dict_resolved['Technical Operating Parameters and Specifications']['Operating capacity factor']['Value'].unit['-']
                                         *
                                         self.heat_duty.unit['W']
                                         /
