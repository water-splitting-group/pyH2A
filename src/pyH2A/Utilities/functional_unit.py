...
def _derived_units():
    ...
    '''
    global Functional_Dimension, Functional_Dimension_per_time, Functional_Unit, Functional_Unit_SI, Functional_Unit_SI_per_s, Functional_Unit_per_year
    ...
    if Functional_Dimension == 'energy':  # special case: energy per time is power
        ...
        Functional_Dimension_per_time = Functional_Dimension + '/time'
        Functional_Unit_SI_per_s = Functional_Unit_SI + '/s'
