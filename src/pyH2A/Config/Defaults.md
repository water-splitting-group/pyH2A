...
production_scaling | function | 3 | core function to process yearly plant output
Capital_Cost_Plugin | plugin | 5 | Calculation of direct, indirect and non-depreciable capital costs
initial_equity_depreciable_capital | function | 7 | core function to process depreciable capital costs
non_depreciable_capital_costs | function | 9 | core function to process non-depreciable capital costs
Replacement_Plugin | plugin | 11 | Calculation of replacement costs
replacement_costs | function | 13 | core function to process replacement costs
Fixed_Operating_Cost_Plugin | plugin | 15 |Calculation of fixed operating costs
fixed_operating_costs | function | 17 | core function to process fixed operating costs
Variable_Operating_Cost_Plugin | plugin | 19 | Calculation of variable operating costs, including utilities
variable_operating_costs | function | 21 | core function to process variable operating costs
