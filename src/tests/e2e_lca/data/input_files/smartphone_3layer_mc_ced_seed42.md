...
Dependent Variable | {Life Cycle Assessment > Results > Value > Cumulative energy demand, kWh / kg} | Path+unit notation resolved via Monte_Carlo_Analysis._resolve_dependent_variable().
