...
class DummyDCF:
    ...
    def __init__(
        self, cold_inlet_temperature, cold_outlet_temperature, hot_outlet_temperature, heat_transfer_coefficient, material_weight_per_area, capacity_factor,temperature, pressure, specific_enthalpy, mass_fraction, yearly_mass, peak_flowrate
    ):
