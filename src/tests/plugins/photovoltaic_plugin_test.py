    ...
    [
        {
            ...
            "expected": {
                ...
                "power_generation_yearly_data_daily_power": {
                    2026: Quantity(np.array([8.014016860274, 8.014016860274]), 'MWh'),
                    2027: Quantity(np.array([7.9739467759728235, 7.9739467759728235]), 'MWh')
                },
            },
        }
    ],
...
def test_photovoltaic_plugin(case):
    ...
    for year in dcf.operation_years:
        np.testing.assert_allclose(
            plugin.power_generation_yearly_data[year].unit['J'],
        ...
        np.testing.assert_allclose(
            plugin.power_generation_yearly_data_daily_power[year].unit["Wh"],
