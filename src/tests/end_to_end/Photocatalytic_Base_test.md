...
Maximum output rate at gate | 90% | {Technical Operating Parameters and Specifications > Plant design capacity > Value, kg/day} | kg/day | % of plant design capacity, reduction due to loss in H2/O2 separation. |
...
--- | --- | --- | --- | --- |
Solar collection area per staffer | Area per staff | 405,000. | m2 | Labor cost based on Pinaud 2013, solar collection area that can be overseen by one staff member. |
