...
Plant Design Capacity (kg of H2/day)  | 2,000 | 
...
Name | Value | Comment
--- | ---  | --- 
Mean solar input (kWh/m2/day) | 12.8 | Typical value in Dagget, CA, USA, with two axis tracking

# Solar-to-Hydrogen Efficiency

Name | Value  | Comment
--- | ---  | --- 
STH (%) | 40.0% | Based on DOE Technical Targets for Hydrogen Production from Thermochemical Water Splitting - 2020 Target
