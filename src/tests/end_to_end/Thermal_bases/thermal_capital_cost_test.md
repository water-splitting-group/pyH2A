...
Name | Value | Comment
--- | --- | --- 
Chemical tower ($) | 4,300,000 | Equipment costs based on DOE Technical Targets for Hydrogen Production from Thermochemical Water Splitting - 2020 Target
...
Name | Value | Comment
--- | --- | ---
Cost of land ($ per acre) | 1000.0 | Land cost based on Pinaud 2013.
