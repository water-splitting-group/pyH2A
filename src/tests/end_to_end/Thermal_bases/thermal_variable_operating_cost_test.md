...
Name | Value
--- | --- 
Operating Capacity Factor (%) | 40.0%
...
--- | --- | --- | --- | --- | --- | --- | ---
Industrial Electricity | 0.86 | kWh/kg H2 | pyH2A.Lookup_Tables.Utility_Cost~Industrial_Electricity_AEO_2017_Reference_Case.csv | GJ | 0.0256  | GJ/kWh | Electricity usage based on Pinaud 2013.
Process Water | 4.369 | gal/kg H2 | 0.0993749510945008 | $(2016)/gal | 2. | None | Seawater reverse osmosis cost ca. 0.6 $/m3 (equal to ca. 0.0023 $/gal), based on Kibria 2021 and Driess 2021.
