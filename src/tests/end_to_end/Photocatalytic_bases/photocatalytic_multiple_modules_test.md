...
Plant Modules | 20 | None | 10 identical modules, only affects labor requirement calculation.
...
--- | --- | --- | ---
area | Area per staff (m2) | 810,000 | Labor cost based on Pinaud 2013, solar collection area that can be overseen by one staff member.
supervisor | Shift supervisor | 2 | Number of shift supervisors.
