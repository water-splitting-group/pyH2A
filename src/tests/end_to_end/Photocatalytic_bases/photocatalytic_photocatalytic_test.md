...
Molar Attenuation Coefficient (M^-1 cm^-1) | 4000 | Assumption for calculation of hypothetical homogeneous water splitting catalyst.

# Reactor Baggies

Name | Value | Comment
--- | --- | ---
Height (m) | 0.10 | Optimal height depends on absorption coefficient of material/complex and catalytic activity (TOF or mol H2/h/g). Height of 5 cm based on experimental set-up used in Kang 2015 (shown in Kang 2015 SI).
Length (m) | 623.0 | Baggie parameters based on Pinaud 2013.
Width (m) | 22.2 |
Cost Material Top ($/m2) | 1.04
Cost Material Bottom ($/m2) | 0.97
Number of ports | 22 | Number of ports per baggie.
Cost of port ($) | 60 | Cost per port.
Other Costs ($) | 1210.7 | Other costs per baggie.
Markup factor | 3.5 | Markup factor of baggies.
Additional land area (%) | 60.0% | Land area required in addition to area occupied by baggies.
Lifetime (years) | 15 | Lifetime of reactor baggies.
