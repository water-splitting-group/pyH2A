...
--- | --- | --- | ---
Solar_Thermal_Plugin | plugin | Computes land area required for thermal process | 4
Compressor_1_Plugin | plugin | Computes first stage of compression, based on the unit operation template | 4
Intercooler_plugin | plugin | Computes cooling between the two stages of compression, based on the unit operation template | 4
Compressor_2_Plugin | plugin | Computes second stage of compression, based on the unit operation template | 4
...
Electricity for compressor 1 | Compressor 1 > Electricity input > Value | kWh/kg H2 | pyH2A.Lookup_Tables.Utility_Cost~Industrial_Electricity_AEO_2017_Reference_Case.csv | GJ | 0.0036 | GJ/kWh | Electricity usage based on Pinaud 2013.
Electricity for compressor 2 | Compressor 2 > Electricity input > Value | kWh/kg H2 | pyH2A.Lookup_Tables.Utility_Cost~Industrial_Electricity_AEO_2017_Reference_Case.csv | GJ | 0.0036 | GJ/kWh | Electricity usage based on Pinaud 2013.
