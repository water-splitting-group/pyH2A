...
Name | Value | Comment
--- | --- | ---
Design Capacity (kWh) | 1600000 | Full design capacity
Lowest discharge level | 40% | Lowest level to which battery can be discharged
Capacity loss per year | 2% | Loss of capacity per year
Round trip efficiency | 50% | For lithium ion battery
