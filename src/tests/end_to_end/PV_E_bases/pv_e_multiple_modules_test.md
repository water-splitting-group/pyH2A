...
Name | Value | Comment
--- | --- | ---
Plant Modules | 20 | Modelling of 20 modules for calculation of staff cost to facilitate comparison with PEC and photocatalytic model.
...
--- | --- | --- | ---
area | Area per staff (m2) | 805,000 | Same as photocatalytic model, solar collection area that can be overseen by one staff member.
supervisor | Shift supervisor | 8 | Same as PEC and photocatalytic model, number of shift supervisors.
shifts | Shifts | 1 | Same as PEC and photocatalytic model, number of shifts per day.
