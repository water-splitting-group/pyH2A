...
--- | --- | --- | --- 
Nominal Power (kW) | 3.5 | Electrolyzer > Nominal Power (kW) > Value | Optimal PV oversize ratio, same as Chang 2020
CAPEX Reference Power (kW) | 1,000.0
Power loss per year | 0.9% | None | Based on Chang 2020
Efficiency | 42% | None | Only used for area calculation.
