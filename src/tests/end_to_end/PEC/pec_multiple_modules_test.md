...
Plant Modules | 40 | None | 10 identical modules, only affects labor requirement calculation.
...
--- | --- | --- | ---
area | Area per staff (m2) | 140,000 | Based on Pinaud et al. 2013, smaller area per staff compared to PV+E and photocatalytic model due to smaller size of individual units, more connections and sensors.
supervisor | Shift supervisor | 6 | Number of shift supervisors.
shifts | Shifts | 1 | Number of shifts per day.
