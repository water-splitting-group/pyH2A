...
Name | Value | Comment
--- | --- | ---
Module Tilt (degrees) | 0.5 | Two axis tracking, module tilt and array azimuth change are not relevant.
Array Azimuth (degrees) | 0.5
Nominal Operating Temperature (Celsius) | 95 | Temperature is stabilized even under solar concentration through intrinsic water cooling.
Mismatch Derating | 48%
Dirt Derating | 49% | Values taken from Chang 2020, analogues to silicon PV.
Temperature Coefficient (per Celsius) | 50.0% | No assumed efficiency loss with higher temperature.
