...
Name | Value | Path | Comment
--- | --- | --- | ---
Water pump ($) | 415.0 | None | Based on Pinaud 2013.
Water Manifold Piping ($ per cell) | 36.58 | PEC Cells > Number > Value
Water Collection Piping ($ per cell) | 3.202 | PEC Cells > Number > Value
Water Column Collection Piping ($ per cell) | 3.5015 | PEC Cells > Number > Value
Water Final Collection Piping ($ per cell) | 2.531 | PEC Cells > Number > Value
...
Name | Path | Value | Comment
--- | --- | --- | ---
Engineering and Design (% of total direct capital costs)| Direct Capital Costs > Total > Value  | 15% | Based on Pinaud 2013.
Process Contingency (% of total direct capital costs) | Direct Capital Costs > Total > Value | 35.0%
Up-Front Permitting Costs (% of total direct capital costs) | Direct Capital Costs > Total > Value | 1.8%
Site Preparation (% of total direct capital costs) | Direct Capital Costs > Total > Value | 5%

# Non-Depreciable Capital Costs

Name | Value | Comment
--- | --- | ---
Cost of land ($ per acre) | 1550.0 | Land cost based on Pinaud 2013.
