...
File A | tests/end_to_end/Photocatalytic_Base_test.md

# Technical Operating Parameters and Specifications

Name | Value | Path | Unit | Comment
--- | --- | --- | --- | ---
Plant modules | 20 | None | - | 20 identical modules, only affects labor requirement calculation. (2x the reference value.)
