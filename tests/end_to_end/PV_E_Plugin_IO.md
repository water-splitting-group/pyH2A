...
--- | --- | --- | --- | ---
Mass | 2 | Plugin A Output > Energy > Value | kg | Value "2" is in unit kg/J, multiplying by "Plugin A Output > Energy > Value" (which is dimension energy, used in basic unit "J") gives kg
