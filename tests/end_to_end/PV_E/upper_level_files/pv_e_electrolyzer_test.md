...
--- | --- | --- | --- 
Nominal power | 10,500 | kW | 1.91× change from reference value (Production of ca. 1 t of H2 per day to compare with PEC and photocatalytic models)
...
Hydrogen yield per unit energy | 0.009 | kg/kWh | 0.49× change from reference value (Based on Chang 2020)
