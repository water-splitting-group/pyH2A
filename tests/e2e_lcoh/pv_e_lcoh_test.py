...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_battery_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_electrolyzer_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_hourly_irradiation_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_multiple_modules_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_photovoltaic_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_power_management_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_reverse_osmosis_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/PV_E/upper_level_files/pv_e_stored_power_electrolysis_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
