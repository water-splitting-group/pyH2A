...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_capital_cost_test.md",
                "output_directory": "tests/end_to_end/",
            },
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_labor_operating_cost_test.md",
                "output_directory": "tests/end_to_end/",
            },
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_production_test.md",
                "output_directory": "tests/end_to_end/",
            },
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_replacement_test.md",
                "output_directory": "tests/end_to_end/",
            },
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_solar_thermal_test.md",
                "output_directory": "tests/end_to_end/",
            },
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Thermal/upper_level_files/thermal_variable_operating_cost_test.md",
                "output_directory": "tests/end_to_end/",
            },
