...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Photocatalytic/upper_level_files/photocatalytic_catalyst_separation_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Photocatalytic/upper_level_files/photocatalytic_hourly_irradiation_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Photocatalytic/upper_level_files/photocatalytic_multiple_modules_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
        ...
        {
            "input": {
                "input_file": "tests/end_to_end/Photocatalytic/upper_level_files/photocatalytic_photocatalytic_test.md",
                "output_directory": "tests/end_to_end/",
            },
            "expected": {
