...
def pv_e_base():
	...
	result = pyH2A('./tests/PV_E/Base/PV_E_Base.md', './tests/Results/PV_E/Base')
...
def pv_e_limit():
	result = pyH2A('./tests/PV_E/Limit/PV_E_Limit.md', '.tests/PV_E/Limit')

def pv_e_distance_time():
	result = pyH2A('./tests/PV_E/Historical_Data/PV_E_Distance_Time.md', './tests/PV_E/Historical_Data')

	print(result.meta_modules['Development_Distance_Time_Analysis']['Module'].p_linear)

def pec_base():

	result = pyH2A('./tests/PEC/Base/PEC_Base.md', './tests/PEC/Base')
	#pprint.pprint(result.base_case.inp['Non-Depreciable Capital Costs'])
	pprint.pprint(result.meta_modules['Monte_Carlo_Analysis']['Module'].shortest_target_distance)

def pec_limit():
	
	result = pyH2A('./tests/PEC/Limit/PEC_Limit.md', './tests/PEC/Limit')
...
def pec_limit_no_concentration():
	...
	result = pyH2A('./tests/PEC/No_Conc/PEC_Limit_No_Concentration.md', './tests/PEC/No_Conc')
...
def photocatalytic_base():
	...
	result = pyH2A('./tests/Photocatalytic/Base/Photocatalytic_Base.md', './tests/Photocatalytic/Base')
...
def photocatalytic_limit():
	...
	result = pyH2A('./tests/Photocatalytic/Limit/Photocatalytic_Limit.md', './tests/Photocatalytic/Limit')
	pprint.pprint(result.base_case.plugs['Photocatalytic_Plugin'].catalyst_properties)

def technology_comparison():
	pec = pyH2A('./tests/PEC/Base/PEC_Base.md', './tests/PEC/Base')
	pc =  pyH2A('./tests/Photocatalytic/Base/Photocatalytic_Base.md', './tests/Photocatalytic/Base')
	pv_e =  pyH2A('./tests/PV_E/Base/PV_E_Base.md', './tests/PV_E/Base')
