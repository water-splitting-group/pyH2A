        ...
        self.inp = {
            'Utilities': {
                ...
                'Water': {
                    'Usage_Value': 2,
                    'Usage_Unit': 'J/kg',
                    # testing that path information is correctly passed and used
                    'Usage_Path': 'Number of units > Bag number > Value',
                    # testing that path information is correctly passed and used
                    'Cost_Value': 'Pump - Other Variable Operating Cost - Brand A > Maintenance > Value',
                    'Cost_Unit': 'USD/J',
                    # testing that path information is correctly passed and used
                    'Cost_Path': 'Number of units > Bag number > Value',
                    'Type': 'water'
                }
            },
            ...
            'Bag - Other Variable Operating Cost': {
                ...
                'Disposal': {
                    ...
                    'Unit': 'USD',
                    # testing that path information is correctly passed and used
                    'Path': 'Number of units > Bag number > Value'
                },
                'Recycling': {
                    'Value': 10,
                    'Unit': 'USD',
                    # testing that multiple path information is correctly passed and used
                    'Path': 'Number of units > Bag number > Value; Catalyst > Lifetime > Value'
                }
            },
            ...
            'Quantity Path Testing': {
                ...
                'PV power': {
                    'Value': 1.5,
                    # testing that path information is correctly passed and used for Quantity objects
                    'Path': 'Quantity Path Testing > Electrolyzer power > Value',
                    'Unit': 'W',
                }
            }
        }
