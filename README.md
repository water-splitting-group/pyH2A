...
```powershell
pytest src/tests/lca/01_lca_gt_e2e_test.py src/tests/lca/02_dcf_lca_gt_pipeline_test.py -v -s
```
...
### 01_lca_gt_e2e_test.py — 14 tests (Level 1)
...
### 02_dcf_lca_gt_pipeline_test.py — 5 tests (Level 2)
